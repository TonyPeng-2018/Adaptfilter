...
axs[0].axhline(y=m_cifar_bw_total/network_speed[0], color='b', linestyle='--',label='100Kbps, raw image')
axs[0].axhline(y=m_cifar_bw_total/network_speed[1], color='g', linestyle='-.',label='250Kbps, raw image')
axs[0].axhline(y=m_cifar_bw_total/network_speed[2], color='r', linestyle=':',label='1Mbps, raw image')
axs[0].set_xlabel('Layer')
axs[0].set_ylabel('Latency(ms)')
axs[0].set_xticks(m_x)
axs[0].legend()
...
axs[1].axhline(y=r_imagenet_bw_total/network_speed[0], color='b', linestyle='--',label='100Kbps, raw image')
axs[1].axhline(y=r_imagenet_bw_total/network_speed[1], color='g', linestyle='-.',label='250Kbps, raw image')
axs[1].axhline(y=r_imagenet_bw_total/network_speed[2], color='r', linestyle=':',label='1Mbps, raw image')
axs[1].set_xlabel('Layer')
axs[1].set_ylabel('Latency(ms)')
axs[1].set_xticks(r_x)
axs[1].legend()
