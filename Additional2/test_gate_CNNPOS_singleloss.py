...
def main(args):
    ...
    logger = utils.APLogger('./Logs/' + args.dataset + '/test_gate_' + p_start_time + '.log')
    ...
    if args.dataset == 'cifar-10':
        num_classes = 10
        train, _, val, classes = dataloader_cifar10.Dataloader_cifar10_val(train_batch=128, test_batch=1, seed=2024)
    ...
    for i in range(len(g_rate)):
        ...
        gates[i].eval()
        gates[i].load_state_dict(torch.load('/home/tonypeng/Workspace1/adaptfilter/Adaptfilter/Weights/cifar-10/gate/mobilenetV2_12_2.pth'))
