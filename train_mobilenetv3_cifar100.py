...
cuda_no = '2'
model = mobilenetv3.mobilenetV3(num_classes=10)
...
logger = utils.APLogger(path='./Logs/cifar-10/mobilenetv3_large_cifar10_' +start_time+ '.log')
logger.write('model: mobilenetv3_large, dataset: cifar10, training')
...
for epoch in tqdm(range(100)):
    ...
    if min_loss < outputs:
        min_loss = loss.item()
        torch.save(model.state_dict(), './Weights/cifar-10/pretrained/mobilenetv3_large_' + start_time + '.pth')
