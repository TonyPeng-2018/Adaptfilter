...
trainset = torchvision.datasets.CIFAR10(
    root=external_path.tintin_path['cifar10'], train=True, download=True, transform=transform_train)
trainloader = torch.utils.data.DataLoader(
    trainset, batch_size=128, shuffle=True, num_workers=8)

testset = torchvision.datasets.CIFAR10(
    root=external_path.tintin_path['cifar10'], train=False, download=True, transform=transform_test)
