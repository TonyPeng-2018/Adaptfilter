...
def mobilenetv2_splitter_client(num_classes = 1000, weight_root = '/home/tonypeng/Workspace1/adaptfilter/Adaptfilter/Weights/imagenet', device = 'cuda:0', partition = -1):
    # here are have a very stupid splitter for 
    # the restnet101 mode
    # assert that they have at least the same length of models
...
class MobileNetV2_repeat(nn.Module):
    def __init__(
        self,
        num_classes: int = 1000,
        width_mult: float = 1.0,
        ...
        self.last_channel = _make_divisible(last_channel * max(1.0, width_mult), round_nearest)
        features: List[nn.Module] = [
            Conv2dNormActivation(3, 32, stride=2, norm_layer=norm_layer, activation_layer=nn.ReLU6),
            Conv2dNormActivation(32, 8, stride=1, norm_layer=norm_layer, activation_layer=nn.ReLU6),
            # Conv2dNormActivation(input_channel, 2*input_channel, stride=2, norm_layer=norm_layer, activation_layer=nn.ReLU6)
        ]
...
class MobileNetV2_direct(nn.Module):
    def __init__(
        self,
        num_classes: int = 1000,
        width_mult: float = 1.0,
...
class MobileNetV2_together(nn.Module):
    def __init__(
        self,
        num_classes: int = 1000,
        width_mult: float = 1.0,
        ...
        features: List[nn.Module] = [
            Conv2dNormActivation(3, input_channel, stride=2, norm_layer=norm_layer, activation_layer=nn.ReLU6),
            Conv2dNormActivation(input_channel, 8, stride=1, norm_layer=norm_layer, activation_layer=nn.ReLU6),
            Conv2dNormActivation(8, input_channel, stride=1, norm_layer=norm_layer, activation_layer=nn.ReLU6),
        ]
...
class MobileNetV2_together_n(nn.Module):
    def __init__(
        self,
        num_classes: int = 1000,
        width_mult: float = 1.0,
        ...
        features: List[nn.Module] = [
            Conv2dNormActivation(3, input_channel, stride=2, norm_layer=norm_layer, activation_layer=nn.ReLU6),
            Conv2dNormActivation(input_channel, middle, stride=1, norm_layer=norm_layer, activation_layer=nn.ReLU6),
            Conv2dNormActivation(middle, input_channel, stride=1, norm_layer=norm_layer, activation_layer=nn.ReLU6),
        ]
...
if __name__ == '__main__':
    ...
    client, server = mobilenetv2_splitter(weight_root= '/home/tonypeng/Workspace1/adaptfilter/Adaptfilter/Weights/cifar-100', num_classes=100, device = 'cuda:0')
