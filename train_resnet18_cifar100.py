...
logger = utils.APLogger(path='./Logs/cifar-100/resnet18_' +start_time+ '.log')
logger.write('model: resnet18, dataset: cifar100, training')
...
for epoch in tqdm(range(100)):
    ...
    if min_loss < outputs:
        min_loss = loss.item()
        torch.save(model.state_dict(), './Weights/cifar-100/pretrained/resnet18_' + start_time + '.pth')
