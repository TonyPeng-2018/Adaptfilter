...
if not os.path.exists(f'Weights/training/{model_type}_coder_{num_of_layers}_{num_of_ch}_{model_time}/'):
    os.mkdir(f'Weights/training/{model_type}_coder_{num_of_layers}_{num_of_ch}_{model_time}/')
print('saving to: ', f'Weights/training/{model_type}_coder_{num_of_layers}_{num_of_ch}_{model_time}/')
...
for epoch in range(epochs):
    ...
    if val_acc > max_val_acc:
        ...
        torch.save({
            ...
            'epoch': epoch,
            'val_acc': val_acc
        }, f'Weights/training/{model_type}_coder_{num_of_layers}_{num_of_ch}_{model_time}/{model_type}_coder_{num_of_layers}_{num_of_ch}.pth')
