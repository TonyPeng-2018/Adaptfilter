...
train, test, val, _ = dataloader_cifar10.Dataloader_cifar10_val(train_batch=128, test_batch=100, seed=2024, 
...
logger = utils.APLogger(path='./Logs/cifar-10/mobilenetv2_' +start_time+ '.log')
logger.write('model: mobilenetv2, dataset: cifar10, training')
...
for epoch in tqdm(range(100)):
    ...
    if min_loss < outputs:
        min_loss = loss.item()
        torch.save(model.state_dict(), './Weights/cifar-10/pretrained/mobilenetv2_' + start_time + '.pth')
